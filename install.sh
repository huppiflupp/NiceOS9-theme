...
echo ""
echo "IMPORTANT: NiceOS9 dark requires the 'ArcDark' color scheme."
echo "Install it via your package manager:"
echo "  Fedora/Nobara:  sudo dnf install arc-kde"
echo "  Arch:           sudo pacman -S arc-kde"
echo "  Ubuntu/Debian:  sudo apt install arc-kde"
echo ""
